<?php
ob_start();
define('API_KEY','307755434:AAHAsXo8eUA8W4mimT00TU8JTSI5ZBMVzPg');
$the_admin_id = 0;
...
//                }break;
                ...
                case '7':{
                    ...
                    if($image_id === false){
                        ...
                        $fule = 'https://api.telegram.org/file/bot307755434:AAHAsXo8eUA8W4mimT00TU8JTSI5ZBMVzPg/'.trim($imag->result->file_path,"\\/");
